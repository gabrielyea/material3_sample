      ...
      child: IntrinsicWidth(
        child: Column(
          ...
          children: <Widget>[
            ...
            FilledButton(
              onPressed: isDisabled ? null : () {},
              child: const Text('Filled primary'),
            ),
            colDivider,
            FilledButton.tonal(
              onPressed: isDisabled ? null : () {},
              child: const Text('Filled secondary'),
            ),
            colDivider,
            FilledButton.tonal(
              onPressed: isDisabled ? null : () {},
              ...
              child:  const Text('Filled tertiary'),
            ),
            colDivider,
            OutlinedButton(
              onPressed: isDisabled ? null : () {},
...
enum ColorItem {
  ...
  dasboardBlack('dashboardBlack', Color.fromARGB(255, 12, 12, 23));
